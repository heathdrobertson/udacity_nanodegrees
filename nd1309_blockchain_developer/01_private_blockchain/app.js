...
/**
 * Docker run command:
 * docker run --rm --volumes-from=nix -it -v $(pwd):/app -w /app -p 8000:8000 nixos/nix nix-shell /app/.config/default.nix
 *
 * To run app:
 * nodemon app.js
 */
...
const CodeMonkey = require('./src/codemonkey_bitcoinjs-lab.js');
...
class ApplicationServer {
	...
	constructor() {
		...
		//CodeMonkey class object
		this.codemonkey = new CodeMonkey.CodeMonkey();
	...
	initControllers() {
        ...
        require("./CodeMonkeyController.js")(this.app, this.codemonkey);
	}
