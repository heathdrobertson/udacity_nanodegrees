...
contract ExerciseC6C {
    ...
    */   
    ...
    function registerEmployee ( string calldata id, bool isAdmin, address wallet) external requireContractOwner {
    ...
    function getEmployeeBonus ( string calldata id) external view requireContractOwner returns(uint256) {
