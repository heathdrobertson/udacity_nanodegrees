...
contract StarNotary is ERC721 {
    ...
    string public constant symbol = "CRST";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        //4. Use _transferFrom(from, to, id) function to exchange the tokens.

        address ownerAddress1 = ownerOf(_tokenId1);
        address ownerAddress2 = ownerOf(_tokenId2);

        require(ownerAddress1 == msg.sender, "Sender must be an owner of one star.");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "Sender is not owner of the star to be transfered");
