...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to);
        require(isOwner() ||  isApprovedForAll(_tokenOwner[tokenId], msg.sender) == true);
        _operatorApprovals[to];
        emit Approval(_tokenOwner[tokenId], _tokenApprovals[tokenId], tokenId);
    }
    ...
    * is an operator of the owner, or is the owner of the token
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "Token with that ID already exists.");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "From address is not the token owner");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    */
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        require(_exists(tokenId), "Token with provided ID does not exist");
...
contract ToiletHillERC721Token is ERC721Metadata(
    "ToiletHill Real Estate Ownership Transfer",
    "THRE",
